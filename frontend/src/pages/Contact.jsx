...
const Contact = () => {
  ...
  return (
    ...
    <>
      <Helmet>
        <title>Contact Us - Cleaning Services in Dubai</title>
        <meta
          name="description"
      ...
      <Layout>
        ...
        <div className="min-h-[480px]">
          <div className="flex flex-col max-w-6xl gap-10 px-4 mx-auto mt-12 md:flex-row">
            {/* Left Section */}
            ...
            <div className="flex w-full md:w-[60%] ">
              <div className="w-full p-4  border border-green-600 rounded shadow-lg bg-gray-100">
